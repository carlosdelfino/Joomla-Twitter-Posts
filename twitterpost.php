...
class plgContentTwitterpost extends JPlugin
	...
	function plgContentTwitterpost(&$subject)
		...
		$this->post_edits = (int) $this->params->get('post_edits');
		}
	...
	function onAfterContentSave($article, $isNew)
		...
		if(($isNew || $this->post_edits) && $article->state)
			{
			...
			if (!$sections || !$categories || in_array($article->catid, $ids_cat) || in_array($article->sectionid, $ids_sec) )
				{
